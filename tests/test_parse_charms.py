...
class TestCharms(unittest.TestCase):
    ...
    def test_charms(self):
        ...
        # 1. Highlight charm
        link1 = "steam://run/730//+csgo_econ_action_preview%20809080984B8AA080A883B08CE880F095228187888090D3D85C86FE064298"
        ...
        # 3. Sticker Slab
        link3 = "steam://run/730//+csgo_econ_action_preview%205949594192537959715A695131592959FB585E5159497C39B858F260BD11"
